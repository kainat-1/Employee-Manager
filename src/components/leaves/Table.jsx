        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
          ...
          <div className="flex gap-2 flex-wrap">
            {["Pending", "Approved", "Rejected"].map((status) => {
              ...
              const colors = {
                Pending: isActive ? "bg-yellow-500" : "bg-yellow-400 hover:bg-yellow-500",
                Approved: isActive ? "bg-green-600" : "bg-green-500 hover:bg-green-600",
                Rejected: isActive ? "bg-red-600" : "bg-red-500 hover:bg-red-600",
              };
              return (
                <button
                  key={status}
                  className={`${baseClass} ${colors[status]}`}
                  onClick={() =>
